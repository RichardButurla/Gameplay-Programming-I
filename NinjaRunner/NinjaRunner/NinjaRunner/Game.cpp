...
void Game::processKeyRelease(sf::Event t_event)
{
	...
	// Run and Stop Attack
				...
				else if (t_event.key.code == sf::Keyboard::V)
				{
					...
					input.setCurrent(gpp::Events::Event::SHOVEL_END_EVENT);
				}
}
...
void Game::setupSprite()
{
	...
	sf::Texture player_texture;
	 if (!player_texture.loadFromFile("ASSETS/IMAGES/PlayerSpriteSheet.png"))
	 {
	...
	AnimatedSprite& ref = *player_animated_sprite;

	player = new Player(ref);
}
