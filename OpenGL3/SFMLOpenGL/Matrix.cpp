...
MyMatrix MyMatrix::rotationAntiClockwiseX(float t_angleDegrees)
{
...
MyMatrix MyMatrix::rotationAntiClockwiseY(float t_angleDegrees)
{
	float angleRadians = t_angleDegrees * PI / 180.0f;
	return MyMatrix{
...
MyMatrix MyMatrix::rotationAntiClockwiseZ(float t_angleDegrees)
{
	float angleRadians = t_angleDegrees * PI / 180.0f;
	return MyMatrix{
...
MyMatrix MyMatrix::translationXY(const MyVector3 t_displacement)
{
	// make sure z == 1
	return MyMatrix{
